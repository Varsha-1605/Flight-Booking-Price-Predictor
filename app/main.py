...
#             text-align: center;
#             color: #FFD700;
#             text-shadow: 3px 3px 4px rgba(255, 215, 0, 0.5);
#         }
...
# # Title
# st.markdown('<p class="title">✈️ Flight Price Prediction</p>', unsafe_allow_html=True)
...
#     st.markdown(f"""
#         <div style="text-align: center; padding: 20px; border-radius: 10px; background: #FFD700;
#                     color: black; font-size: 24px; font-weight: bold; box-shadow: 3px 3px 6px rgba(255, 215, 0, 0.4);">
